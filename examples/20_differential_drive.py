...
reading the robot's estimated pose.  Two versions are shown:
  ...
  • Simple (2 motors, one per side) — uncomment SIMPLE CONFIG below.
...
rl = robot.motor(robot.D2)   # rear-left  — likely needs inverting
fr = robot.motor(robot.D1)   # front-right — likely needs inverting
...
# Drive backward to roughly the starting point
